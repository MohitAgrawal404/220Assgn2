...
if __name__ == "__main__":
    ...
    plot_metric(descriptor_data, args.simulation_path, 'memory.stat.0.csv', os.path.join(args.output_dir, "ICACHE.pdf"), "ICACHE_MISS_pct", "ICACHE miss ratio percent")
    plot_metric(descriptor_data, args.simulation_path, 'bp.stat.0.csv', os.path.join(args.output_dir, "BP.pdf"), "BP_ON_PATH_MISPREDICT_pct", "On path miss ratio percent")
